          ...
          <div className="relative overflow-hidden rounded-sm border border-border/40 bg-surface/20 p-1 min-h-[400px] flex items-center justify-center">
            ...
            <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2 px-4 z-10">
              <button 
                ...
                className="px-3 py-1.5 bg-background/80 hover:bg-red-500/20 border border-border/50 hover:border-red-500/50 rounded-sm font-mono text-[9px] uppercase tracking-wider text-foreground transition-colors backdrop-blur-sm"
              >
                Inject Data Noise
              </button>
              <button 
                onClick={handleSimulateStragglers}
                className="px-3 py-1.5 bg-background/80 hover:bg-amber-500/20 border border-border/50 hover:border-amber-500/50 rounded-sm font-mono text-[9px] uppercase tracking-wider text-foreground transition-colors backdrop-blur-sm"
              >
                Trigger Stragglers
              </button>
              <button 
                onClick={handlePersonalizeModels}
                className="px-3 py-1.5 bg-background/80 hover:bg-purple-500/20 border border-border/50 hover:border-purple-500/50 rounded-sm font-mono text-[9px] uppercase tracking-wider text-foreground transition-colors backdrop-blur-sm"
              >
                Personalize Models
              </button>
              <button 
                onClick={handleReset}
                className="px-3 py-1.5 bg-background/80 hover:bg-accent/20 border border-border/50 hover:border-accent/50 rounded-sm font-mono text-[9px] uppercase tracking-wider text-foreground transition-colors backdrop-blur-sm ml-auto"
              >
                Reset
              </button>
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6 border border-border/40 bg-surface/10 p-5 rounded-sm relative min-h-[420px]">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2.5 border border-border/30 bg-surface/20 p-4 rounded-sm transition-colors duration-300 min-h-[240px]">
              ...
              <div
                className={cn(
                  "flex flex-col gap-2.5 transition-[opacity,transform,filter] duration-150 ease-in-out",
